export function getCertificateEmail(
  userName: string,
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .code { background: #f4f4f5; padding: 16px; border-radius: 8px; font-size: 16px; font-weight: bold; text-align: center; letter-spacing: 2px; color: #18181b; margin: 16px 0; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Use this code to verify the authenticity of your certificate.</p>
