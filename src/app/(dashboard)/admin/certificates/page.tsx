...
const certificates = [
  { id: 1, title: "National Cricket Champion", recipient: "Priya Sharma", type: "Achievement", issued: "2024-05-20", status: "Issued" },
  { id: 2, title: "Best Coach Award", recipient: "Rahul Verma", type: "Award", issued: "2024-04-15", status: "Issued" },
  { id: 3, title: "State Tennis Winner", recipient: "Neha Gupta", type: "Achievement", issued: "2024-06-01", status: "Pending" },
  { id: 4, title: "Football Excellence", recipient: "Rohan Joshi", type: "Achievement", issued: "2024-03-28", status: "Issued" },
  { id: 5, title: "Athletics Star Performer", recipient: "Sunita Reddy", type: "Award", issued: "2024-05-10", status: "Issued" },
  { id: 6, title: "School Sports Championship", recipient: "Delhi Public School", type: "Institution", issued: "2024-06-05", status: "Revoked" },
];
...
export default function CertificatesPage() {
  ...
  return (
    <div>
      <DashboardHeader title="Certificate Management" subtitle="Manage all certificates" />
                ...
                {filtered.map((cert) => (
                  <tr key={cert.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-900/50">
                    ...
                    <td className="py-3 px-4">
                      <Badge variant={cert.status === "Issued" ? "default" : cert.status === "Pending" ? "outline" : "destructive"}>
                        {cert.status}
                      </Badge>
                    </td>
                    <td className="py-3 px-4">
